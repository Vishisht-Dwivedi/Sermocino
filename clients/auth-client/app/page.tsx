  ...
  return (
    <main className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-2">
      <div className="relative flex flex-col items-center justify-center px-10 py-16 text-center">
        ...
        <h1 className="mt-1 w-2/3 flex items-center justify-center gap-4 text-5xl font-bold tracking-tight text-emerald-800">
          <span className="flex-1 h-1 bg-emerald-300"></span>
          Sermocino
          <span className="flex-1 h-1 bg-emerald-300"></span>
        </h1>
        <p className="mt-3 text-lg text-emerald-900/70 max-w-sm w-2/3 flex items-center justify-center gap-4">
          <span className="flex-1 h-1 bg-emerald-300"></span>
      ...
      <div className="relative flex items-center justify-center px-6 py-16">
        <Tabs defaultValue="login" className="w-full max-w-md">
          <TabsList className="flex w-full mb-2 rounded-md border border-emerald-400/20 bg-emerald-50/60 py-6 backdrop-blur">
