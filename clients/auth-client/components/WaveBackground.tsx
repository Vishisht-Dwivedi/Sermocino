...
export default function WaveBackground() {
    ...
    useEffect(() => {
        ...
        class Wave {
            constructor(height: number, direction: number, amplitudeArray: number[], phaseArray: number[], frequencyArray: number[], color: string) {
            ...
            draw() {
                ...
                for (let i = -steps; i <= steps; i++) {
                    ...
                    for (let j = 0; j < this.amplitudeArray.length; j++) {
                        displacement += this.amplitudeArray[j] *
                            Math.sin(
